...
@Component({
  selector: 'app-votar-feos',
  templateUrl: './votar-feos.page.html',
  styleUrls: ['./votar-feos.page.scss'],
})
export class VotarFeosPage implements OnInit {
